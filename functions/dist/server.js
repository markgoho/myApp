...
var eventListenerCount = __webpack_require__(57).eventListenerCount
...
var contentDisposition = __webpack_require__(33);
...
var codes = __webpack_require__(129)
...
var getBody = __webpack_require__(124)
var iconv = __webpack_require__(51)
...
lazyProperty(module.exports, 'callSiteToString', function callSiteToString () {
  ...
  return stack[0].toString ? toString : __webpack_require__(132)
})
...
var accepts = __webpack_require__(28)
var Buffer = __webpack_require__(62).Buffer
var bytes = __webpack_require__(6)
var compressible = __webpack_require__(61)
...
var accepts = __webpack_require__(28);
var deprecate = __webpack_require__(3)('express');
var isIP = __webpack_require__(53).isIP;
...
module.exports = {
    ...
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(25).concat(__webpack_require__(50)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(49).concat(__webpack_require__(103)) },
...
var deprecate = __webpack_require__(122)('http-errors')
...
var bodyParser = __webpack_require__(133)
var EventEmitter = __webpack_require__(21).EventEmitter;
...
Zone.__load_patch('node_timers', function (global, Zone) {
    ...
    try {
        var timers = __webpack_require__(137);
...
var express = __webpack_require__(135);
...
var DIST_FOLDER = path_1.join(process.cwd(), 'dist/myApp');
exports.app.get('*.*', express.static(path_1.join(DIST_FOLDER), {
    maxAge: '1y'
}));
exports.app.get('/*', function (req, res) {
    res.sendFile(path_1.join(DIST_FOLDER + '/index.html'));
});
